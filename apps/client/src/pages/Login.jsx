...
const Login = () => {
  return (
    <div>
      <h1 className="text-center text-4xl font-bold phone:mt-5">Bienvenido de Vuelta</h1>
      <p className="text-center pt-5 phone:mx-2">
        Inicia sesión y descubre todo lo nuevo que tenemos para ti
      </p>
      <div className="flex justify-center phone:flex-col flex-row ">
